...
PRODUCT_COPY_FILES += \
    vendor/candy/prebuilt/common/etc/init/init.pixelexperience-updater.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.pixelexperience-updater.rc
...
PRODUCT_COPY_FILES += \
    vendor/candy/config/permissions/android.software.nfc.beam.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/permissions/android.software.nfc.beam.xml
...
# Power whitelist
PRODUCT_COPY_FILES += \
    vendor/candy/config/permissions/custom-power-whitelist.xml:system/etc/sysconfig/custom-power-whitelist.xml
...
# RRO Overlays
$(call inherit-product, vendor/candy/config/rro_overlays.mk)
