...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/candy/fonts/prebuilt,$(TARGET_COPY_OUT_PRODUCT)/fonts) \
    vendor/candy/fonts/fonts_customization.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/fonts_customization.xml
